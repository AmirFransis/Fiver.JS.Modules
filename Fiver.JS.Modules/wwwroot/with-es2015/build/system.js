...
!function () {
  ...
  function e(e) {
    ...
    return function (s) {
      for (var u = 0; u < r.length; u++) {
        if (r[u] === s) {
          var c,
              f = n[u];return (c = f instanceof l ? f : k(e, f, f.linkRecord, o, i, a)).__useDefault || c;
        }
    ...
    a.push(r);var s;if (n.setters) for (var u, c, f = 0; f < n.dependencies.length; f++) {
      ...
      var d = { id: r.key },
        ...
        g(n.dependencies[f]);
      }s = j(n.execute, g, p.default, d), d.exports !== p.default && (p.default = p.__useDefault = d.exports);var h = p.default;if (h && h.__esModule) for (var m in h) {
    ...
    if (Pt || Mt) {
      var t = document.createElement("link");Pt ? (t.rel = "preload", t.as = "script") : t.rel = "prefetch", t.href = e, document.head.appendChild(t), document.head.removeChild(t);
    ...
    "/" === i[i.length - 1] && (i = i.substr(0, i.length - 1));var u = r.map[o];if ("object" == (typeof u === "undefined" ? "undefined" : _typeof(u))) throw new Error("Synchronous conditional normalization not supported sync normalizing " + o + " in " + n);if (se(o, u, i) && "string" == typeof u) return V.call(this, t, u + i.substr(o.length), n + "/", a, a, s);
    ...
    return Promise.resolve(r).then(function (t) {
      return "detect" === n.load.format && (n.load.format = void 0), Ve(t, n), n.pluginModule && n.pluginModule.translate ? (n.pluginLoad.source = t, Promise.resolve(n.pluginModule.translate.call(e, n.pluginLoad, n.traceOpts)).then(function (e) {
        if (n.load.sourceMap) {
  ...
  }, et.prototype.version = "0.20.17 Dev";var _r = new et();(ot || _t) && (st.SystemJS = st.System = _r), "undefined" != typeof module && module.exports && (module.exports = _r);
}();